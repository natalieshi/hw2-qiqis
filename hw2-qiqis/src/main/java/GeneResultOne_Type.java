 ...
 * @generated */
public class GeneResultOne_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (GeneResultOne_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = GeneResultOne_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new GeneResultOne(addr, GeneResultOne_Type.this);
  			   GeneResultOne_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new GeneResultOne(addr, GeneResultOne_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = GeneResultOne.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("GeneResultOne");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "GeneResultOne");
  ...
  public int getStartPoint(int addr) {
      ...
      jcas.throwFeatMissing("startPoint", "GeneResultOne");
  ...
  public int getEndPoint(int addr) {
      ...
      jcas.throwFeatMissing("endPoint", "GeneResultOne");
  ...
  public String getGeneName(int addr) {
      ...
      jcas.throwFeatMissing("geneName", "GeneResultOne");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public GeneResultOne_Type(JCas jcas, Type casType) {
    super(jcas, casType);
